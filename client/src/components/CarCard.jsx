...
const CarCard = ({car}) => {
  ...
  return (
    <div onClick={()=> {navigate(`/car-details/${car._id}`); scrollTo(0,0)}} className='group rounded-xl overflow-hidden border border-transparent bg-white shadow-md hover:-translate-y-1.5 hover:shadow-[0_12px_30px_-5px_rgba(37,99,235,0.15)] hover:border-primary/20 transition-all duration-500 cursor-pointer'>
